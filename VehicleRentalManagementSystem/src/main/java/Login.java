    ...
    public static class ConcreteCustomer extends Customer {
        ...
        public void showList() {
            while (true) {
                ...
                System.out.println("3. Rate your Rentals");
                System.out.println("4. Loyalty Status and Rental Exeptions");
                ...
                switch (choice) {
                    ...
                    case 2:
                        ...
                        break;
                    case 3:
                        // customerFunctions.viewRental();    // Rate your Rentals
                        break;
                    case 4:
                        //customerFunctions.addNewRental("", ""); // viewLoyaltyStatus();
                        break;
                    case 5:
